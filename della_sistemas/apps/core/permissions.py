...
PERMISSION_TREE = [
    ...
    {
        "id": "private_label",
        "label": "Financeiro — Private Label",
        "perms": [
            {"id": "ver_dashboard",     "label": "Ver Dashboard"},
            {"id": "ver_lancamentos",   "label": "Ver Lançamentos"},
            {"id": "lancar",            "label": "Criar/editar/baixar/cancelar lançamentos"},
            {"id": "ver_fluxo_caixa",   "label": "Ver Fluxo de Caixa"},
            {"id": "ver_cartoes",       "label": "Ver Cartões"},
            {"id": "ver_dre",           "label": "Ver DRE"},
            {"id": "ver_investimentos", "label": "Ver Investimentos"},
            {"id": "configurar",        "label": "Configurar contas, categorias, centros de custo, contatos e formas de pagamento"},
            {"id": "ajustar_saldo",     "label": "Ajustar saldo manualmente (ação sensível)"},
            {"id": "baixar_valor_maior","label": "Dar baixa com valor acima do saldo da parcela (ação sensível)"},
            {"id": "conciliar",         "label": "Conciliar extrato bancário"},
        ],
    },
    {
        "id": "motoqueiro",
        "label": "Financeiro — Motoqueiro",
        "perms": [
            {"id": "ver_relatorio",  "label": "Ver relatório (só as próprias corridas)"},
            {"id": "ver_dashboard",  "label": "Ver dashboard (cards, gráficos)"},
            {"id": "solicitar",      "label": "Solicitar corrida (Lalamove/Loggi)"},
            {"id": "solicitar_para_outros", "label": "Solicitar em nome de outro funcionário (gestor)"},
            {"id": "ver_todos",      "label": "Ver corridas de TODOS os funcionários, não só as próprias (gestor)"},
            {"id": "editar_status",  "label": "Corrigir status manualmente"},
            {"id": "gerir_saldo",    "label": "Ver e lançar saldo da carteira Lalamove (ação sensível)"},
            {"id": "monitorar",      "label": "Monitorar cotação até um preço-alvo (avisa no Telegram)"},
        ],
    },
    {
        "id": "analytics",
        ...
        "perms": [
            ...
            {"id": "ver_anuncios",  "label": "Ver Anúncios (investimento e resultado das campanhas Meta)"},
...
DEFAULT_PERMS_BY_PAPEL = {
    "superadmin": {
        ...
        "financeiro":      {"ver": True},
        "private_label": {
            "ver_dashboard": True, "ver_lancamentos": True, "lancar": True,
            "ver_fluxo_caixa": True, "ver_cartoes": True, "ver_dre": True,
            "ver_investimentos": True, "configurar": True,
            "ajustar_saldo": True, "baixar_valor_maior": True, "conciliar": True,
        },
        "motoqueiro":  {"ver_relatorio": True, "ver_dashboard": True, "solicitar": True, "solicitar_para_outros": True, "ver_todos": True, "editar_status": True, "gerir_saldo": True, "monitorar": True},
    ...
    "gestor": {
        ...
        "private_label": {
            "ver_dashboard": False, "ver_lancamentos": False, "lancar": False,
            "ver_fluxo_caixa": False, "ver_cartoes": False, "ver_dre": False,
            "ver_investimentos": False, "configurar": False,
            "ajustar_saldo": False, "baixar_valor_maior": False, "conciliar": False,
        },
        "motoqueiro":  {"ver_relatorio": False, "ver_dashboard": False, "solicitar": False, "solicitar_para_outros": False, "ver_todos": False, "editar_status": False, "gerir_saldo": False, "monitorar": False},
        "aprovacoes": {"ver": True,       "aprovar": True},
        "precos":     {"ver": True,       "alterar": True},
